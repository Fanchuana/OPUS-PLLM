...
def eval_model(args):
    ...
    tokenizer, model, context_len = load_pretrained_model(
        args.model_base_path, args.adapter_path, model_name, args.load_8bit, args.load_4bit, accelerator = None, switch_projector_type=args.switch_projector_type,cstp_path=cstp_path
    )
